...
import { slides, limit, urls } from "../content/FinalChapter";
        ...
        <main>
            ...
            > 
                {   slide === 0 ?
                    <FaceChapter 
                        title={"Final Chapter"}
                        description={"Congratulations, you've reached the end! We're glad to have had you join us on this adventure."}
                        img={'/images/final-chapter/final.jpg'}
                        alt={"adventures logo"}
                    /> :
